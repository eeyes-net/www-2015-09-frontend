...
;(function($){
	$.fn.fullScreenSlider=function(options){
		var defaults={
			...
			fullScreen: false, //设置ture则宽高按全屏处理，否则填满外围容器
		...
		return this.each(function(){
			...
			//添加左右滚动箭头
			var arrayLeft="<a class='mos-array-left'></a>";
			var arrayRight="<a class='mos-array-right'></a>";
